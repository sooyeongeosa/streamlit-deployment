...
# classification_report를 DataFrame으로 변환
...
classification_df = classification_report_to_df(classification_report(y_test, y_pred, target_names=le_label.classes_))
